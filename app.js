...
var showAnswerers = function(answerers) {
	...
	// Set Answer properties in result
	var answerersElem = result.find('.answerers-text a');
	answerersElem.attr('href', answerers.user.link);
	answerersElem.text(answerers.user.user_id);
	...
	image.text(answerers.user.profile_image);
